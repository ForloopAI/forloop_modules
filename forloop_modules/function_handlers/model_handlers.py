...
class LoadPythonScriptHandler(AbstractFunctionHandler):
    ...
    def make_form_dict_list(self, *args, options={}, node_detail_form=None):
        ...
        fdl.button(function=self.open_python_script, function_args=node_detail_form, text="Look up file", enforce_required=False, name="lookup_file")
...
class LoadJupyterScriptHandler(AbstractFunctionHandler):
    ...
    def make_form_dict_list(self, *args, options={}, node_detail_form=None):
        ...
        fdl.button(function=self.open_jupyter_script, function_args=node_detail_form, text="Look up file", enforce_required=False, name="lookup_file")
        fdl.label("Load and run")
        fdl.checkbox(name="load_and_run", bool_value=False, row=3)
        fdl.button(function=self.execute, function_args=node_detail_form, text="Execute", focused=True)
